...
import { Divider, Wrapper, Heading, Subtitle, ImageContainer, SingleImage, CardContainer } from './listingComponents';
...
export function Listing({ listingId, name, address, type, price, images, description, length, width, height, distance }) {
  ...
  return (
      ...
      <Card onClick={handleNavigate} style={{ marginBottom: "3vh", height: "auto", alignItem: "center", justifyContent: "center" }} shadow="lg" radius="lg" withBorder>
        <Divider>
          <ImageContainer>
            {images.length >= 2 && (
